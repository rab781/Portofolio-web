...
## 2025-05-24 - Hoisting Framer Motion Configurations
**Learning:** Defining static Framer Motion configuration objects or arrays inside component bodies triggers unnecessary allocations during initial mounts and re-renders.
**Action:** Always hoist static Framer Motion configurations outside of the component body to maintain referential equality and avoid unnecessary allocations.
