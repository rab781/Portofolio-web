...
// PYTHON (Blue & Yellow)
// ----------------------------------------------------------------------
// ⚡ Bolt: Wrapped stateless SVG icons with React.memo() to prevent unnecessary O(N) re-evaluations
...
// REACT (Cyan)
// ----------------------------------------------------------------------
export const ReactIcon = memo(function ReactIcon({ size = 24, className }: IconProps) {
    return (
...
// JAVASCRIPT (Yellow)
// ----------------------------------------------------------------------
export const JSIcon = memo(function JSIcon({ size = 24, className }: IconProps) {
    return (
    <svg aria-hidden="true" focusable="false" width={size} height={size} viewBox="0 0 48 48" className={className}>
...
// TYPESCRIPT (Blue)
// ----------------------------------------------------------------------
export const TSIcon = memo(function TSIcon({ size = 24, className }: IconProps) {
    return (
    <svg aria-hidden="true" focusable="false" width={size} height={size} viewBox="0 0 48 48" className={className}>
...
// NEXT.JS (Black/White)
// ----------------------------------------------------------------------
export const NextIcon = memo(function NextIcon({ size = 24, className }: IconProps) {
    return (
    <svg aria-hidden="true" focusable="false" width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
// TAILWIND (Cyan)
// ----------------------------------------------------------------------
export const TailwindIcon = memo(function TailwindIcon({ size = 24, className }: IconProps) {
    return (
    <svg aria-hidden="true" focusable="false" width={size} height={size} viewBox="0 0 24 24" className={className}>
...
// GIT (Red/Orange)
// ----------------------------------------------------------------------
export const GitIcon = memo(function GitIcon({ size = 24, className }: IconProps) {
    return (
    <svg aria-hidden="true" focusable="false" width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
// TENSORFLOW (Orange)
// ----------------------------------------------------------------------
export const TensorflowIcon = memo(function TensorflowIcon({ size = 24, className }: IconProps) {
    return (
    <svg aria-hidden="true" focusable="false" width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export const LaravelIcon = memo(function LaravelIcon({ size = 24, className }: IconProps) { return <Globe size={size} className={className} color="#FF2D20" aria-hidden="true" />; });
export const PandasIcon = memo(function PandasIcon({ size = 24, className }: IconProps) { return <BarChart3 size={size} className={className} color="#150458" aria-hidden="true" />; });
export const NumPyIcon = memo(function NumPyIcon({ size = 24, className }: IconProps) { return <Binary size={size} className={className} color="#4D77CF" aria-hidden="true" />; });
export const SkLearnIcon = memo(function SkLearnIcon({ size = 24, className }: IconProps) { return <Database size={size} className={className} color="#F7931E" aria-hidden="true" />; });
export const DockerIcon = memo(function DockerIcon({ size = 24, className }: IconProps) { return <Box size={size} className={className} color="#2496ED" aria-hidden="true" />; });
export const StreamlitIcon = memo(function StreamlitIcon({ size = 24, className }: IconProps) { return <PlayCircle size={size} className={className} color="#FF4B4B" aria-hidden="true" />; });
