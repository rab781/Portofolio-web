...
// ⚡ Bolt: Adding React.memo() to all static icon components prevents unnecessary
// re-renders of the entire SVG tree when parent components (like MarqueeRow) update,
// significantly improving performance for pages with many icons.
...
export const LaravelIcon = memo(function LaravelIcon({ size = 24, className }: IconProps) {
    return <Globe size={size} className={className} color="#FF2D20" />;
});
export const PandasIcon = memo(function PandasIcon({ size = 24, className }: IconProps) {
    return <BarChart3 size={size} className={className} color="#150458" />;
});
export const NumPyIcon = memo(function NumPyIcon({ size = 24, className }: IconProps) {
    return <Binary size={size} className={className} color="#4D77CF" />;
});
export const SkLearnIcon = memo(function SkLearnIcon({ size = 24, className }: IconProps) {
    return <Database size={size} className={className} color="#F7931E" />;
});
export const DockerIcon = memo(function DockerIcon({ size = 24, className }: IconProps) {
    return <Box size={size} className={className} color="#2496ED" />;
});
export const StreamlitIcon = memo(function StreamlitIcon({ size = 24, className }: IconProps) {
    return <PlayCircle size={size} className={className} color="#FF4B4B" />;
});
