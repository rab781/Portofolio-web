...
export const LaravelIcon = ({ size = 24, className }: IconProps) => <Globe size={size} className={className} color="#FF2D20" aria-hidden="true" />;
export const PandasIcon = ({ size = 24, className }: IconProps) => <BarChart3 size={size} className={className} color="#150458" aria-hidden="true" />;
export const NumPyIcon = ({ size = 24, className }: IconProps) => <Binary size={size} className={className} color="#4D77CF" aria-hidden="true" />;
export const SkLearnIcon = ({ size = 24, className }: IconProps) => <Database size={size} className={className} color="#F7931E" aria-hidden="true" />;
export const DockerIcon = ({ size = 24, className }: IconProps) => <Box size={size} className={className} color="#2496ED" aria-hidden="true" />;
export const StreamlitIcon = ({ size = 24, className }: IconProps) => <PlayCircle size={size} className={className} color="#FF4B4B" aria-hidden="true" />;
