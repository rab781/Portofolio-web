    ...
    <div className="max-w-7xl mx-auto px-6 sm:px-12 py-20">
          ...
          <div className="space-y-8">
            <div className="flex items-start">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <a href="mailto:raihanrabani199@gmail.com" className="text-xl font-medium text-white hover:text-gray-300 transition-colors focus-visible:ring-2 focus-visible:ring-[#FFA239] focus-visible:outline-none rounded-sm">
                  ...
                  <button
                    ...
                    className="text-gray-400 hover:text-white transition-colors p-1 rounded-md hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-[#FFA239] focus-visible:outline-none"
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <a href="tel:+6285824665623" className="text-xl font-medium text-white hover:text-gray-300 transition-colors focus-visible:ring-2 focus-visible:ring-[#FFA239] focus-visible:outline-none rounded-sm">
                  +62 858-2466-5623
                </a>
              </div>
            </div>
      ...
      <div className="pt-20 mt-8 border-t border-gray-800 text-center md:text-left flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
        ...
        <div className="flex space-x-6 mt-4 md:mt-0">
          <a href="#" className="hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-[#FFA239] focus-visible:outline-none rounded-sm">LinkedIn</a>
          <a href="#" className="hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-[#FFA239] focus-visible:outline-none rounded-sm">GitHub</a>
          <a href="#" className="hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-[#FFA239] focus-visible:outline-none rounded-sm">Twitter</a>
        </div>
      </div>
    </div>
  );
