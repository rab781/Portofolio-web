        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 text-[#111111]">
          <form ref={formRef} onSubmit={handleSubmit} onKeyDown={handleKeyDown} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  aria-required="true"
                  maxLength={100}
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black transition-all"
            ...
            <button
              ...
              className={`w-full bg-[#111111] text-white px-8 py-4 rounded-lg font-bold hover:bg-black transition-all flex items-center justify-center group relative overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFA239] focus-visible:ring-offset-2 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
            >
  ...
  return (
    <div>
      ...
      <textarea
        ...
        rows={4}
        className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black transition-all resize-none"
