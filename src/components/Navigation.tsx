      ...
      >
        <div className="relative px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <a
              href="#home"
              className="flex items-center space-x-2 group z-10 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFA239] focus-visible:ring-offset-2"
            >
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <a
                    key={link.href}
                    href={link.href}
                    className={`px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFA239] focus-visible:ring-offset-2 ${isActive
            ...
            <div className="md:hidden">
              <button
                ...
                className="text-gray-900 p-2 hover:bg-gray-100 rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFA239] focus-visible:ring-offset-2"
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <a
                    key={link.href}
                    href={link.href}
                    className={`block px-4 py-3 rounded-xl text-base font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFA239] focus-visible:ring-offset-2 ${isActive
