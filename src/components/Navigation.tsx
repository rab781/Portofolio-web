      ...
      >
        <div className="relative px-6 lg:px-8">
          <div className="flex justify-between items-center">
            {/* Logo */}
            <a href="#home" className="flex items-center space-x-2 group z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFA239] rounded-lg">
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <a
                    ...
                    className={`px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFA239] ${isActive
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <a
                    ...
                    href={link.href}
                    aria-current={isActive ? "true" : undefined}
                    className={`block px-4 py-3 rounded-xl text-base font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFA239] ${isActive
