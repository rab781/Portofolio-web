...
export default function HeroBackground() {
    ...
    useEffect(() => {
        ...
        const handleMouseMove = (e: MouseEvent) => {
            if (!ticking) {
                // ⚡ Bolt: Throttle style updates with requestAnimationFrame
                window.requestAnimationFrame(() => {
                    // Evaluate getBoundingClientRect inside rAF to ensure fresh layout data
                    // without causing synchronous layout thrashing during mousemove
