...
// ⚡ Bolt: Hoist static scroll offset configuration outside of the component body to prevent unnecessary array allocations during initial mount or non-scroll re-renders.
