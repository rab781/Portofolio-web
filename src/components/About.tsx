...
import { motion, useInView, useMotionValue, useSpring, UseInViewOptions, SpringOptions } from "framer-motion";
...
// ⚡ Bolt: Hoist static Framer Motion configs to prevent object allocations during initial mount/non-scroll re-renders
