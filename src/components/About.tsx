...
// ⚡ Bolt: Hoisted static spring configuration object outside the component body
// to prevent unnecessary object allocations on initial mount and non-scroll re-renders.
