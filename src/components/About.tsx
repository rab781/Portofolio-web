...
const MagneticPortrait = dynamic(() => import("./MagneticPortrait"), {
  ssr: false,
});
...
// ⚡ Bolt: Hoist static Framer Motion config object to prevent allocations on every render
...
function About({ hideImage = false, triggerAnimation = false }: AboutProps) {
  return (
    ...
    >
      <div
        className={`grid ${hideImage ? "md:grid-cols-1" : "md:grid-cols-2"} gap-16 items-start`}
      >
        {/* Content Column */}
        <div className="space-y-12 pt-4 relative">
          ...
          <motion.div variants={itemVariants} className="relative z-10">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="hidden md:block">
                <CircularBadge
                  text="AI ENGINEER • BUILDING FUTURE • "
                  radius={45}
                  className="opacity-80 text-[#FFA239]"
                />
              </div>
            </div>
          ...
          {hideImage && (
            <div className="h-[45vh] md:h-[60vh] w-full" aria-hidden="true" />
          )}

          {/* Description Paragraphs - Multi-column feel */}
          <motion.div
            variants={itemVariants}
            className="grid md:grid-cols-[1fr] gap-8 text-xl text-gray-600 leading-relaxed font-light"
          >
            <p>
              I am Mohammad Raihan Rabbani. I don&apos;t just write code; I
              orchestrate{" "}
              <strong className="text-[#111111] font-semibold">
                intelligence
              </strong>
              . Standing at the intersection of Artifical Intelligence and
              Software Engineering, I translate complex research papers into
              deployed products.
            </p>
            <p className="border-l-2 border-[#FFA239] pl-6 italic text-gray-800">
              &quot;Building systems that can see, learn, and trade—solving
              human problems with data-driven precision.&quot;
            </p>
          </motion.div>
          ...
          <motion.div
            variants={itemVariants}
            className="grid grid-cols-2 gap-12 pt-8 border-t border-gray-100"
          >
            <div className="space-y-1">
              ...
              <p className="text-body text-base sm:text-lg">
                ...
                &{" "}
                <span className="font-bold text-brand-black">AI Engineer</span>{" "}
                who loves turning messy data into clear, actionable insights.
              </p>
            </div>
            <div className="space-y-1">
              <p className="text-body text-base sm:text-lg">
                My approach is simple:{" "}
                <span className="italic text-brand-black">
                  &quot;Build things that matter.&quot;
                </span>{" "}
                Whether it&apos;s a predictive model for finance or a computer
                vision system for historical archives, I focus on impact.
              </p>
          ...
          <motion.div variants={itemVariants} className="pt-8">
            ...
            >
              <span className="border-b-2 border-[#111111] group-hover:border-[#FFA239] pb-0.5">
                Download Curriculum Vitae
              </span>
              <svg
                className="w-5 h-5 transform group-hover:-translate-y-1 group-hover:-translate-x-1 transition-transform"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                aria-hidden="true"
