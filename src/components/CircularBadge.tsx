...
// ⚡ Bolt: Hoist static configuration object for useInView hook outside the component body.
// This prevents new object allocations on every render cycle, avoiding unnecessary garbage collection
// and re-evaluations inside the hook.
const IN_VIEW_CONFIG: UseInViewOptions = { margin: "0px 0px -50px 0px" };
